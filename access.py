        ...
        async with conn.transaction():
            ...
            await conn.execute("""
                ...
                SET active=TRUE,
                    ...
                    subscription_expires=$6,
                    blocked=FALSE
            """, user_id, str(user_id), key, _gen_code("REF", 8), plan_id, expires)

    return {"user_id": user_id, "key": key, "expires": expires, "days": days, "plan_id": plan_id}
