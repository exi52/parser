...
PLATFORMS = [
    ...
    check_snapshot,
    check_blur_api,
    # check_opensea_html  — не включён: HTML часто отдаёт чужие адреса.
    # check_rainbow_html  — не включён: HTML часто отдаёт чужие адреса.
    # check_zapper_html   — не включён: HTML часто отдаёт чужие адреса.
]
